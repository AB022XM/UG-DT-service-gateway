...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("absa.digital.ug.gatewayservices.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("absa.digital.ug.gatewayservices.security.DomainUserDetailsService", "createSpringSecurityUser");
