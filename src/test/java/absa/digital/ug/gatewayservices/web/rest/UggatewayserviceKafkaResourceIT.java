...
@WithMockUser
@EmbeddedKafka
class UggatewayserviceKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/uggatewayservice-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/uggatewayservice-kafka/consume")
