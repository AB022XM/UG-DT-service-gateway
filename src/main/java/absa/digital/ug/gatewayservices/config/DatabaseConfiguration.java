...
@Configuration
@EnableR2dbcRepositories({ "absa.digital.ug.gatewayservices.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("absa.digital.ug.gatewayservices.repository.search")
